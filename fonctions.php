...
function connect() {
	# Se connecter a  la BD sur le serveur, retourner la connexion
...
function liste_cat() {
	...
	# Generer le HTML qui contient la liste des categories	

	# Connexion
	$cnn = connect();

	# Definir la requete et l'executer
	...
	# $code est la variable qui contient le HTML; on ajoute un element de la liste
	# pour chaque type de velo dans la BD
	$code = "<ul>";
...
function infos_modele($modele) {
	...
	# Definir une requete dont le filtre est l'ID de modele passe
	...
	# Extraire les donnees retournees par la requete, mettre dans des variables
	...
	# Inserer les variables dans le code HTML
